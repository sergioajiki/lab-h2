...
public class EnderecoController {
    ...
    public ResponseEntity<EnderecoVo> getEnderecoById(Long id) {
    ...
    public ResponseEntity<String> cadastrarEndereco(EnderecoVo endereco) {
    ...
    public ResponseEntity<String> updateEndereco(Long id, EnderecoVo endereco) {
        EnderecoVo enderecoById = enderecoService.updateEnderecoById(id, endereco);
        return ResponseEntity.status(HttpStatus.OK).body("Endereço com a id " + endereco.getId() + " foi atualizado com sucesso!");
    }

    @DeleteMapping("/{id}")
    @Operation(description = "Apaga o registro de um endereço selecionado por Id")
    public ResponseEntity<String> deleteEndereco(Long id) {
